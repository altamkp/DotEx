...
public static class FloatExtensions {
    ...
    public static float Trim(this float value, float precision = MathDef.DEFAULT_PRECISION) {
    ...
    public static bool IsEqualApprox(this float a, float b, float precision = MathDef.DEFAULT_PRECISION) {
    ...
    public static bool IsZeroApprox(this float value, float precision = MathDef.DEFAULT_PRECISION) {
